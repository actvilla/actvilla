...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
             <h3 style="text-align: center;">Special Discounted Room Rates at Colombo City Hotel </h3>
            <h4 style="text-align: center; color: red;">(Limited rooms are available on a first come, first served basis.)</h4>
            <form id="intexform" name="intexform" class="form-horizontal" method="POST" action="output/tcpdf/examples/hotel-colombocity.php">

                <div class="form-group">
                    <div class="col-sm-4">
                        <label class="radio-inline"><input type="radio" name="standard" class="standard" value="Standard-Single : USD 85 Nett" usd="85" required>Standard-Single : USD 85 Nett</label>
                    </div>
                    <div class="col-sm-4">
                        <label class="radio-inline"><input type="radio" name="standard" class="standard" value="Standard-Double : USD 95 Nett" usd="95">Standard-Double : USD 95 Nett</label>
                    </div>
                    <div class="col-sm-4">
                        <label class="radio-inline"><input type="radio" name="standard" class="standard" value="Standard-Twin : USD 95 Nett" usd="95">Standard-Twin : USD 95 Nett</label>
                    </div>
                </div>
